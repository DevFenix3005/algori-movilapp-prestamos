...
source.dir = ./src/algori_movilapp_prestamos
...
requirements = python3, kivy==2.3.1, https://github.com/kivymd/KivyMD/archive/master.zip, exceptiongroup, asynckivy, asyncgui, materialyoucolor, android, matplotlib==3.10.6
